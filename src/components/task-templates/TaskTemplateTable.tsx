...
const TaskTemplateTable = <T,>({
  ...
  */
  ...
  const handleSubmit = async (values: TaskTemplateFormikInitialValues, formik: FormikHelpers<TaskTemplateFormikInitialValues>) => {
    ...
    asyncUpdateRecords(payload).then((data) => {
      const { inserted, updated } =
        data as unknown as UpdateModelsData<TaskTemplateModel>;
      ...
      Object.keys(inserted).forEach((idx) => {
        ...
        formik.setFieldValue(`${pluralizedModelName}[${idx}]`, {
          ...
          touched: false,
          [primaryKeyFieldName]:
            inserted[numIdx][primaryKeyFieldName as keyof TaskTemplateModel],
        });
      });
