...
interface TagFormProps {
  ...
  hiddenField?: string;
  onSubmit?: (
    values: TagFormFormikInitialValues,
    formik: FormikHelpers<TagFormFormikInitialValues>
  ) => void;
}
...
const TagForm: React.FC<TagFormProps> = (prop) => {
  ...
  const tag = modelQuery.data as TagFormFormikInitialValues;

  const isLarge = useScreenSize("lg");
  const initialValues = getInitialValues<TagFormFormikInitialValues>(
    modelConfig,
    tag,
  ...
  const handleFormikSubmit = (
    ...
    const goToNewRecord = () => {
      formik.setValues(
        getInitialValues<TagFormFormikInitialValues>(
          modelConfig,
          undefined,
          { requiredList }
        )
  ...
  const renderFormik = (
    formik: FormikProps<TagFormFormikInitialValues>
  ) => {
