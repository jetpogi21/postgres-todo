...
export const GET = async (req: Request) => {
  ...
  const query = parseParams(searchParams) as Partial<TaskTagSearchParams>;
...
export const DELETE = async (req: Request) => {
  ...
  const body = (await req.json()) as TaskTagDeletePayload;
  const { deletedTaskTags } = body;
