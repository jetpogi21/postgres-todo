...
export const TaskConfig: ModelConfig = {
  ...
  isModal: null,
  hooks: [
    //Generated by GetAllSeqModelHookKeys
    {
      seqModelHookID: 1,
      seqModelID: 85,
      caption: "Add From Templates",
      order: 1,
      slug: "add-from-templates",
      snakeCase: "add_from_templates",
    },
  ],
  fields: [
  ...
  filters: [
    ...
    },
    {
      ...
      filterOperator: "Equal",
      options: [
        //Generated by GetAllSeqModelFilterOptionKeys
        {
          seqModelFilterOptionID: 3,
          fieldValue: "1",
          fieldCaption: "Finished",
        },
        {
          seqModelFilterOptionID: 4,
          fieldValue: "0",
          fieldCaption: "Pending",
        },
      ],
    },
    {
