...
export interface TaskTagFormikShape extends Omit<TaskTagModel, "slug" | "createdAt" | "updatedAt" 
...
export interface TaskTagSelectedPayload {
  selectedTaskTags: string[] | number[];
}
