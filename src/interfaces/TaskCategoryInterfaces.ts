...
//Generated by GetRelatedInterfaceImport - RelatedInterfaceImport
import { TaskTemplateFormikInitialValues, TaskTemplateFormikShape,TaskTemplateModel,TaskTemplateUpdatePayload } from "@/interfaces/TaskTemplateInterfaces";
...
export interface TaskCategoryFormikShape extends Omit<TaskCategoryModel, "slug" | "createdAt" | "updatedAt" 
...
export interface TaskCategorySelectedPayload {
  selectedTaskCategories: string[] | number[];
}
